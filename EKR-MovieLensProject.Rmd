...
```{r echo=FALSE}
kable(fit_pop_result, caption = "Popular model, *normalize* parameter tuning")
```  
Quite surprisingly, our results show that the Z-score normalization, albeit more refined, is less accurate than the center normalization.

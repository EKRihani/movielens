...
\paragraph*{}
The aim of this study is to analyze a MovieLens dataset[@movielens] and try to create a model that can predict users' future preferences based on their current preferences, using data analysis and machine learning techniques.

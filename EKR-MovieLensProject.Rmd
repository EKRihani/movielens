...
#TIME VS SIZE PLOT
The computing time vs dataset size scatterplot seems to show a lower computing time for SVD, Popular and LIMBF models, whereas the UBCF model seems considerably slower. Furthermore, the computing time of this model seems to exhibit a quadratic behaviour, whereas the others seem to be linear.  
The UBCF model, while quite accurate, will probably be too slow for this study.

#RMSE VS SIZE PLOT
##### A FAIRE + TROUVER STABILISATION #####

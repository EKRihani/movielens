...
Our next step is to take into account the time variable. However, there are numerous time variable that could be taken into account : the year of the movie, the year of the rating, the time that is elapsed between the movie and the rating, and even the month or the day of the rating, if we want t take into account some seasonal or weekly effect.    
